	...
	if (in_array($_FILES['imagen']['type'], $permitidos) && $_FILES['imagen']['size'] <= $limite_kb * 1024){
		...
		if (!file_exists($ruta)){
			...
			if ($resultado){
				...
				@mysqli_query($conn, "INSERT INTO eventos (imagen, titulo) VALUES ('$nombre', '$titulo')");
				//echo $date;
                echo "<p class='text-center'>Se ha agregado el evento exitosamente.<p>";
                echo "<p class='text-center'><a href='agregareventos.php'>Atrás.</a></p>";
